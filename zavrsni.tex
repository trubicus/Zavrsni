...
C3000 i RN-131 moduli nemaju programljivi mikrokontroler, ne koriste suvremeni 802.11n standard koji je znatno brži te su cjenovno i po nekoliko puta skuplji od vrlo moćnih ESP modula.
Iz tog su se razloga ESP moduli probili na tržištu i u tolikoj mjeri se proširili.
...
U Flask okruženju resursi se prikazuju kao klase kojima se pridjeljuje kraj putanje URL-a. 
To se postiže dodavanjem resursa navodeći odgovarajuću klasu te definicijom krajnje točke:
\begin{lstlisting}
 api.add_resource(Devices, "/devices")
\end{lstlisting}

Unutar klase navode se metode imena \textit{get, put, post} i \textit{delete} koje odgovaraju HTTP zahtjevima koji mogu biti poslani.
Svaka metoda implementira odgovarajuće akcije za tu klasu.
...
Get metoda implementira spajanje na bazu podataka, izvršavanje SQL upita te vraćanje JSON prikaza cijele baze podataka.
% }}}
